...
namespace LeapMotion_Gesture
{
    public partial class Form1 : Form, ILeapEventDelegate
    {
        ...
        private Timer UnlockGestureTimer = null;
        ...
        public Form1()
        {
            ...
            this.UnlockGestureTimer = new Timer();
            UnlockGestureTimer.Tick += new EventHandler(UnlockTimerTimeout);
            UnlockGestureTimer.Interval = 2000;
        ...
        private void UnlockTimerTimeout(object sender, EventArgs e)
        {
            this.Unlocked = false;
        }
